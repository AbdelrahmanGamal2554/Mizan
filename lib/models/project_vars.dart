...
const kfontHandjet = "Handjet";
const kfontLemonada = "Lemonada";
const kfontReadexPro = "ReadexPro";
const kfontReemKufi = "ReemKufi";
const kfontGulzar = "Gulzar";
